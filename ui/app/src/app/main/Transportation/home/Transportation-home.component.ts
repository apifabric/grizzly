...
@Component({
  selector: 'Transportation-home',
  templateUrl: './Transportation-home.component.html',
  styleUrls: ['./Transportation-home.component.scss']
})
export class TransportationHomeComponent implements AfterViewInit {
