...
@Component({
  selector: 'TransportationBooking-home',
  templateUrl: './TransportationBooking-home.component.html',
  styleUrls: ['./TransportationBooking-home.component.scss']
})
export class TransportationBookingHomeComponent implements AfterViewInit {
