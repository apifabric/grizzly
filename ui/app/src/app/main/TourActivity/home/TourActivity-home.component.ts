...
@Component({
  selector: 'TourActivity-home',
  templateUrl: './TourActivity-home.component.html',
  styleUrls: ['./TourActivity-home.component.scss']
})
export class TourActivityHomeComponent implements AfterViewInit {
