...
@Component({
  selector: 'GuideAssignment-home',
  templateUrl: './GuideAssignment-home.component.html',
  styleUrls: ['./GuideAssignment-home.component.scss']
})
export class GuideAssignmentHomeComponent implements AfterViewInit {
