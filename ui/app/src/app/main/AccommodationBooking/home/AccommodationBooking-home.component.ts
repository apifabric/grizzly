...
@Component({
  selector: 'AccommodationBooking-home',
  templateUrl: './AccommodationBooking-home.component.html',
  styleUrls: ['./AccommodationBooking-home.component.scss']
})
export class AccommodationBookingHomeComponent implements AfterViewInit {
